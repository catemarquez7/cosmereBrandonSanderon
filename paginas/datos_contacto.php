    ...
    <section>
        <div class="container-fluid">
            <div class="row azul">
                <div class="col-1"></div>
                <div class="col-10">
                    <h4 class="letra letrablanca padding">Gracias por contactarnos!</h4>
                    <div class="azul letra letrablanca parrafo ">
                        <?php
                        $nom;
                        $mail;
                        $info;
                ...
                <div class="row blanco">
                    <div class="col-1"></div>
                    <div class="col-10">
                        <p class="letra pad parrafo letrablanca">Tené en cuenta lo siguiente:
                            <br> <br>
